...
public:
    ...
    void mesh_around_push_new();

    bool saveDateSTL(QString &aFileName,Model& model_s);
...
private:
    QVector<QList<Vertex>> my_hash_new;
    QVector<QList<Vertex>> my_hash_new_2;

    QVector<Vertex> my_hash;
    Ui::MainWindow *ui;
    Model model;
    Model sample_model;
